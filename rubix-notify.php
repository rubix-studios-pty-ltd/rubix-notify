 ...
 * Description: Send WordPress login alerts to ntfy when users sign in, helping site owners and administrators monitor access activity across self-hosted and managed WordPress sites.
 * Version: 1.0.0
